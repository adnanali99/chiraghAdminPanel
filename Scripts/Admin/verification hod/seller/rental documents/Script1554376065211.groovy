...
WebUI.doubleClick(findTestObject('Object Repository/verification hod/rental documents/Page_Chiragh.com Admin/div_Rental'))

if(WebUI.verifyElementPresent(findTestObject('Object Repository/verification hod/rental documents/Page_Chiragh.com Admin/span_Yes'),4))
{
	WebUI.click(findTestObject('Object Repository/verification hod/rental documents/Page_Chiragh.com Admin/a_Property rental Details_atta'))

	WebUI.verifyElementPresent(findTestObject('Object Repository/verification hod/rental documents/Page_Chiragh.com Admin/img'),4)
