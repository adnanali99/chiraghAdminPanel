...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/a_My Leads'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/a_Reichel Trail 3 Floors Build'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/div_Valuation'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/div_Brokerage Proposal'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/div_Brokerage Proposal'))

WebUI.delay(5)

WebUI.uploadFile(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/img_Form A_ng-star-inserted'),
				 'C:\\Users\\HP\\Katalon Studio\\Chiragh(Admin)\\Include\\pdf\\MarketAnalysis.pdf')


WebUI.uploadFile(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/img_Brokerage Report_ng-star-i'),
	'C:\\Users\\HP\\Katalon Studio\\Chiragh(Admin)\\Include\\pdf\\MarketAnalysis.pdf')

WebUI.delay(5)

WebUI.setText(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/input_Open Price Range (AED)_o'),
	'3000000')

WebUI.setText(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/input_Open Price Range (AED)_o_7'),
	'6000000')

WebUI.setText(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/input_Reserve Price Range (AED'),
	'7000000')

WebUI.setText(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/input_Reserve Price Range (AED_7'),
	'9000000')

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/button_Submit for Approval'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/img'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/button_AM'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/a_In Process'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/a_June Light Hotel_fas fa-bars_1'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/div_Documents'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/i_Call Seller_fas fa-calendar-'))

WebUI.delay(3)

WebUI.setText(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/input_Schedule a Brokerage Mee'),
	'Brokerage Meeting')

WebUI.setText(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/textarea_Schedule a Brokerage'),
	'Brokerage Meeting')

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/span_Schedule a Brokerage Meet'))

/*WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/span_Mar 2019'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/span_2019'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/button_SAVE (1)'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/Page_Chiragh.com Admin/img'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/a_June Light Hotel_fas fa-bars'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/span_7'))
...
//WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/div_Form A uploaded_mat-checkb'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh/div_Login or Register'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh/a_Login'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh/a_Profile'))
		 
WebUI.waitForPageLoad(5)
		 WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh/a_Activity'))
		 WebUI.delay(5)
		 WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh/a_In Process'))
		 WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh/a_Property Id 52482_ellipisIco'))
		 WebUI.delay(3)
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/div_Check List'))
		 
WebUI.delay(3)
		 
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/button_Confirm'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/img1'))
...
WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/a_Cordia Tunnel Hotel'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/div_Check List_2'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/button_Approve_1'))

WebUI.click(findTestObject('Object Repository/brokerage department/Page_Chiragh.com Admin/button_Yes'))
