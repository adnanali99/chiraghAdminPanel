...
String AED = WebUI.getText(findTestObject('Object Repository/Front End Objects/Transaction(AED)/Page_Chiragh - User Account Summary/span_111069888000'))

CustomKeywords.'com.chiragh.com.ChiraghOTP.checkBalance'(AED)
...
CustomKeywords.'com.chiragh.com.ChiraghOTP.generateOtp'('transfer', '2', GlobalVariable.otpNo)
...
////
WebUI.scrollToElement(findTestObject('Object Repository/Front End Objects/Transaction(AED)/Page_Chiragh - Transfer Your Money/input_SMS OTP _smsOtp'), 
    2)
...
String USDAfter = WebUI.getText(findTestObject('Object Repository/Front End Objects/Transaction(AED)/Page_Chiragh - User Account Summary/span_134141594000'))
...
if (GlobalVariable.transferAmount > 100000) {
    CustomKeywords.'com.sanitytest.com.AdminFinanceDeparment.transfereFlowOfFinanceDepartmentgreatertheThousand'()
} else {
    CustomKeywords.'com.sanitytest.com.AdminFinanceDeparment.transfereFlowOfFinanceDepartmentlesstheThousand'()
}
